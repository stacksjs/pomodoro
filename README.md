...
[![npm version](https://img.shields.io/npm/v/@stacksjs/pomodoro?style=flat-square)](https://npmjs.com/package/@stacksjs/pomodoro)
[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/stacksjs/pomodoro/ci.yml?style=flat-square&branch=main)](https://github.com/stacksjs/pomodoro/actions?query=workflow%3Aci)
